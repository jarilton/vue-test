  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-8">
        ...
        <Lance
          ref="novoLance"
          :lanceMinimo="valorMinimoDoLance"
          v-on:novo-lance="onNovoLance"
        />
        <div class="row mb-4 lances" v-if="existemLances">
          <div class="col-6">
            <div class="menor-lance shadow p-3 bg-white rounded">
              Menor lance: <strong>R$ {{ menorLance }}</strong>
            </div>
          </div>
          <div class="col-6">
            <div class="maior-lance shadow p-3 bg-white rounded">
              Maior lance: <strong>R$ {{ maiorLance }}</strong>
            </div>
          </div>
        </div>
      </div>
        ...
        >
          <ul class="list-inline m-0">
            <li class="list-inline-item">
              Data: <strong>{{ lance.data.toLocaleString() }}</strong>
            </li>
            <li class="list-inline-item">
              Valor: <strong>R$ {{ lance.valor }}</strong>
            </li>
          </ul>
        </div>
      </div>
